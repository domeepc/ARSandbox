...
class SurfaceRenderer:public GLObject
	...
	struct DataItem:public GLObject::DataItem
		...
		GLint heightMapShaderUniforms[20]; // Locations of the height map shader's uniform variables
	...
	GLfloat contourLineWidth; // Width of topographic contour lines in screen pixels
	GLfloat reliefStrength; // Strength of relief shading, 0.0 (unlit) to 1.0 (full Lambertian)
	...
	void setContourLineWidth(GLfloat newContourLineWidth); // Sets the width of topographic contour lines in screen pixels
	void setReliefStrength(GLfloat newReliefStrength); // Sets the strength of relief shading
